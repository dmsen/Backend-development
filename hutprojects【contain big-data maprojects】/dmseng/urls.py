...
urlpatterns = [
    ...
    url('^hutUser/readNotice$', hutViews.test_user_readNotice, name='test_user_readNotice'),
    url('^hutUser/readEdNotice$', hutViews.test_user_readEdNotice, name='test_user_readEdNotice'),
    # 湖工大软件工程系统课程课程信息管理
